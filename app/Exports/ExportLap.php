...
class ExportLap implements FromCollection,  WithMapping, WithHeadings, ShouldAutoSize
{
    ...
    public function collection()
    {
       ...
       return Laporan::with('pelapor')->where('created_at','>=',$this->from)->where('created_at','<=',$this->to)->where('status','=','belum diperbaiki')->select()->get();
